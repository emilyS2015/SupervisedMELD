    ...
    def __init__(self, Y, Yt, k, vec, Phi = np.array([])):
        ...
        for j in range(p):
            if Yt[j] == 0:
                ...
                if j in np.array([1,7,8,9,10,11,12,17,18,19,20,21,
                                 22,27,28,29,31,32,33,34,41,43]):
                    self.d[j]=3
                elif j in np.array([0,2,3,4,36,37,38]):
                    self.d[j]=2
                elif j in np.array([5,14,15,16,24,25,26,35]):
                    self.d[j]=4
                elif j in np.array([6,23,39,40,42,44]):
                    self.d[j]=5
                else:
                    self.d[j]=6            
